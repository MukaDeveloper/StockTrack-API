...
ALTER TABLE [ST_SOLICITATIONS] ADD [ExpectReturnAt] datetime2 NOT NULL DEFAULT '0001-01-01T00:00:00.0000000';
GO

ALTER TABLE [ST_SOLICITATION_MATERIALS] ADD [Status] int NOT NULL DEFAULT 0;
GO

UPDATE [ST_AREAS] SET [CreatedAt] = '2024-11-23T01:19:45.4301698Z', [UpdatedAt] = '2024-11-23T01:19:45.4301699Z'
WHERE [Id] = 1;
SELECT @@ROWCOUNT;

GO

UPDATE [ST_MATERIALS] SET [CreatedAt] = '2024-11-23T01:19:45.4301757Z', [UpdatedAt] = '2024-11-23T01:19:45.4301758Z'
WHERE [Id] = 1;
SELECT @@ROWCOUNT;

GO

UPDATE [ST_MOVIMENTATIONS] SET [Date] = '2024-11-22T22:19:45.4301853-03:00'
WHERE [Id] = 1;
SELECT @@ROWCOUNT;

GO

UPDATE [ST_USERS] SET [CreatedAt] = '2024-11-22T22:19:45.4301391-03:00', [PasswordHash] = 0x8B816BC9560ED3B4FED4492403DBE5B8851994DE6CA88C96C71F86639A66C69EDA8CF6EB906856D9B002829A797254E443063A8D892B4601D92E7C432388FC01, [PasswordSalt] = , [VerifiedAt] = '2024-11-22T22:19:45.4301404-03:00'
WHERE [Id] = 1;
SELECT @@ROWCOUNT;

GO

UPDATE [ST_WAREHOUSES] SET [CreatedAt] = '2024-11-23T01:19:45.4301727Z', [UpdatedAt] = '2024-11-23T01:19:45.4301727Z'
WHERE [Id] = 1;
SELECT @@ROWCOUNT;
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20241123011948_AlterSolicitationTables', N'8.0.7');
GO

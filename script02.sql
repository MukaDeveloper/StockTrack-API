...
ALTER TABLE [ST_MOVIMENTATIONS] ADD [Event] int NOT NULL DEFAULT 0;
GO

ALTER TABLE [ST_MOVIMENTATIONS] ADD [MovimentationBy] nvarchar(max) NOT NULL DEFAULT N'';
GO
...
UPDATE [ST_AREAS] SET [CreatedAt] = '2024-09-18T20:33:28.7731142Z'
WHERE [Id] = 1;
SELECT @@ROWCOUNT;

GO

UPDATE [ST_MATERIALS] SET [CreatedAt] = '2024-09-18T20:33:28.7731260Z'
WHERE [Id] = 1;
SELECT @@ROWCOUNT;

GO

UPDATE [ST_MOVIMENTATIONS] SET [Date] = '2024-09-18T17:33:28.7731294-03:00', [Event] = 1, [MovimentationBy] = N'Admin', [UserId] = NULL
WHERE [Id] = 1;
SELECT @@ROWCOUNT;

GO

UPDATE [ST_USERS] SET [PasswordHash] = 0xF39C35D613A53A400C02E4848BDDB5FFC6489A336F17573BB09D82C56CC21B68FFAB25368050C13476A9C62685943926CEC9995615DEAA58F0158B80141933DD, [PasswordSalt] = 
WHERE [Id] = 1;
SELECT @@ROWCOUNT;

GO

UPDATE [ST_WAREHOUSES] SET [CreatedAt] = '2024-09-18T20:33:28.7731171Z'
WHERE [Id] = 1;
SELECT @@ROWCOUNT;
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20240918203329_EventEntity', N'8.0.7');
GO
